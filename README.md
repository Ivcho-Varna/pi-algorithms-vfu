...
1. **Nilakantha е безспорен победител по точност** - постига желаната прецизност с драстично по-малко итерации
2. **Wallis е малко по-ефективен от Leibniz** - изисква ~20-25% по-малко итерации за постигане на същата точност
3. **Скоростта на сходимост** - Nilakantha има експоненциална скорост на подобряване, докато другите два са линейни

### Производителност и скорост

1. **Рекурсивните версии са 5-28 пъти по-бавни** от итеративните при големи обеми данни
2. **Leibniz (итеративен) е най-бърз** за изпълнение, но с най-ниска точност
3. **Nilakantha осигурява перфектна точност** при 1 милион итерации, въпреки че е малко по-бавен
